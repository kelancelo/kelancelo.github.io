...
function Skills() {
    var skills = [{ img: '/static/images/skills/bootstrap.svg', name: 'Bootstrap', type: 'client-side' }, { img: '/static/images/skills/c.svg', name: 'C', type: 'language' }, { img: '/static/images/skills/css3.svg', name: 'CSS3', type: 'client-side' }, { img: '/static/images/skills/django.svg', name: 'Django', type: 'server-side' }, { img: '/static/images/skills/express.svg', name: 'Express', type: 'server-side' }, { img: '/static/images/skills/git.svg', name: 'Git', type: 'others' }, { img: '/static/images/skills/github.svg', name: 'Github', type: 'others' }, { img: '/static/images/skills/html5.svg', name: 'HTML5', type: 'client-side' }, { img: '/static/images/skills/java.svg', name: 'Java', type: 'language' }, { img: '/static/images/skills/javascript.svg', name: 'Javascript', type: 'language' }, { img: '/static/images/skills/mysql.svg', name: 'MySQL', type: 'database' }, { img: '/static/images/skills/nextjs.svg', name: 'Next.js', type: 'server-side' }, { img: '/static/images/skills/nodejs.svg', name: 'Node.js', type: 'server-side' }, { img: '/static/images/skills/python.svg', name: 'Python', type: 'language' }, { img: '/static/images/skills/postgresql.svg', name: 'PostgreSQL', type: 'database' }, { img: '/static/images/skills/react.svg', name: 'React', type: 'client-side' }];
